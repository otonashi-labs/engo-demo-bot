...
You will receive the *processed text brew* we have described earlier. Your only bojective is to decide whether you will buy or sell ETH. Based on the data you will have.
...
Answer ONLY with the JSON file in the following format:
{
     "action" : "BUY" / "SELL"
     "confidence" : [0.0 -- 1.0] score for how confident are you,
     "explanation" : succinct argumentation supporting your decision 
}
    
Please make sure to follow ALL guidelines precisely
